import{i as h}from"./vscodeInject-00cbac9b.js";import{_ as p,a as R}from"./option-67f192ce.js";import{_ as g,a as T}from"./form-5f4bfdcd.js";import{_ as D}from"./dialog-fd368818.js";import{_ as M}from"./checkbox-266d4466.js";import{u as C}from"./umy-table.common-7962b0a6.js";import{D as E,c as w,a as W}from"./codeMirror-f076efbb.js";import{S as d,d as A,t as b,w as $,E as Y,b as V}from"./stringUtil-5a8406a6.js";import{i as x}from"./viewUtil-be301156.js";import{d as q,m as f}from"./app-0e602f39.js";import{n as L,_ as j}from"./vueConfig-4610971c.js";import{s as B,e as y}from"./notify-3cbc54b7.js";import{_ as K}from"./switch-480f8347.js";import{A as v}from"./arrayUtil-94b6619c.js";import"./scrollbar-749e4151.js";import"./index-14b8440c.js";import"./focus-34de79c8.js";import"./index-f37b6d04.js";import"./index-f06350f9.js";class _{dropIndex(e,t){throw new Error("Method not implemented.")}showVersion(){return null}showIndex(e,t){return null}createIndex(e){return null}showDatabases(){return null}updateUser(e){return null}showCollations(){return null}showPackages(e){return null}showChecks(e,t){return null}showPartitions(e,t){return null}showActualPartitions(e,t){return null}showForeignKeys(e,t){return null}updateColumnSql(e){throw new Error("Method not implemented.")}showEvents(e){return`SELECT EVENT_NAME "name" FROM information_schema.EVENTS where EVENT_SCHEMA='${e}' ORDER BY EVENT_NAME;`}dropEventTemplate(e){return`DROP EVENT IF EXISTS ${e};`}eventTemplate(){return`CREATE EVENT event_name$1
ON SCHEDULE AT CURRENT_TIMESTAMP + INTERVAL 1 HOUR
DO
BEGIN
    SELECT now()$2;
END;`}pingDataBase(e,t){return null}dropTriggerTemplate(e){return`DROP TRIGGER IF EXISTS ${e}`}}class X extends _{showVersion(){return"select version() server_version"}createIndex(e){const t=e.indexType||"btree";return`CREATE INDEX ${e.column}_${new Date().getTime()}_index ON ${e.table} USING ${t} (${e.column})`}dropIndex(e,t){return`DROP INDEX ${t}`}showIndex(e,t){return`select name index_name,is_in_sorting_key indexdef  FROM system.columns WHERE database = '${e}' and table ='${t}' and indexdef=1`}variableList(){return"select name , value as setting,description from system.settings s "}statusList(){return"select name as db , engine as status from system.databases d "}processList(){return`
...
BEGIN 
    $2
    RETURN x*2;
END;`}}class J extends F{showVersion(){return`SELECT REPLACE(banner,'DM Database Server 64 ','') "server_version"  FROM v$version where rownum=1;`}createIndex(e){const{table:t,column:n="$2"}=e;return`CREATE INDEX ${`${t}_${n}`} ON ${t}(${n});`}dropIndex(e,t){return`DROP INDEX ${t};`}showIndex(e,t){return`SELECT COLUMN_NAME "column_name",INDEX_NAME "index_name" from DBA_IND_COLUMNS WHERE TABLE_OWNER='${e}' and TABLE_NAME='${t}';`}variableList(){return"show global VARIABLES"}statusList(){return"show global status"}processList(){return"show processlist"}addColumn(e,t){return`ALTER TABLE ${e} 
    ADD COLUMN $1 $2;
...
}`}viewTemplate(){return""}procedureTemplate(){return""}triggerTemplate(){return""}functionTemplate(){return""}}class H extends _{showVersion(){return"select @@version server_version;"}createIndex(e){let t=`${e.type||"key"}`;return t.match(/BTREE/i)&&(t="key"),`ALTER TABLE ${e.table} ADD ${t} (\`${e.column||"$1"}\`)`}dropIndex(e,t){return`ALTER TABLE ${e} DROP INDEX \`${t}\``}showIndex(e,t){return`SELECT column_name "column_name",index_name "index_name",index_type "index_type",non_unique=0 "isUnique" FROM INFORMATION_SCHEMA.STATISTICS WHERE table_schema='${e}' and table_name='${t}';`}variableList(){return"show global VARIABLES"}statusList(){return"show global status"}processList(){return"show processlist"}addColumn(e,t){const n=t?` AFTER \`${t}\``:"";return`ALTER TABLE ${e} 
...
GRANT ALL PRIVILEGES ON *.* TO '$1'@'%' WITH GRANT OPTION;`}updateUser(e){return`update mysql.user set 
    ...
    where User = '${e}';
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var N;const{name:n,type:r,comment:o,nullable:s,defaultValue:l,extra:i,character_set_name:c,collation_name:m}=t,u=s!="YES";return new d(`ALTER TABLE ${e}`).append(`
	CHANGE ${n} ${n} ${r}`).if(c,`CHARACTER SET ${c}`).if(m,`COLLATE ${m}`).if(u,"NOT NULL").if((N=i==null?void 0:i.toLowerCase())==null?void 0:N.includes("auto_increment"),"AUTO_INCREMENT").if(o,`COMMENT '${o}'`).if(A(l)&&!u,"DEFAULT NULL").if(!A(l),`DEFAULT ${l=="CURRENT_TIMESTAMP"?l:`'${b(l)}'`}`).toString()}updateColumnSql(e){const{table:t,columnName:n,name:r,type:o,isNotNull:s,isAutoIncrement:l,comment:i,defaultValue:c,character_set_name:m,collation_name:u}=e;return new d(`ALTER TABLE \`${t}\``).append(`
	CHANGE \`${n}\` \`${r}\` ${o}`).if(m,`CHARACTER SET ${m}`).if(u,`COLLATE ${u}`).if(s,"NOT NULL").if(l,"AUTO_INCREMENT").if(i,`COMMENT '${i}'`).if(A(c)&&!s,"DEFAULT NULL").if(!A(c),`DEFAULT ${c=="CURRENT_TIMESTAMP"?c:`'${b(c)}'`}`).append(";").toString()}showCollations(){return'select DEFAULT_COLLATE_NAME "name",CHARACTER_SET_NAME "charset",DESCRIPTION "description" from information_schema.CHARACTER_SETS ORDER BY name;'}showChecks(e,t){return`SELECT
...
COMMENT ON COLUMN ${e}.${n} IS '${o||"comment"}';`}updateColumnSql(e){const{table:t,columnName:n,newColumnName:r,columnType:o,isNotNull:s,isAutoIncrement:l,comment:i,defaultValue:c,oldRow:m}=e,u=c==null?void 0:c.match(/nextval/),N=l&&!m.isAutoIncrement&&!u,k=!l&&m.isAutoIncrement&&!u,U=!l&&m.isAutoIncrement&&u,G=s?"SET NOT NULL":"DROP NOT NULL";return new d(`ALTER TABLE "${t}" ALTER COLUMN "${n}" TYPE ${o};`,`
`).append(`ALTER TABLE "${t}" ALTER COLUMN "${n}" ${G};`).if(N,`ALTER TABLE "${t}" ALTER "${n}" ADD GENERATED ALWAYS AS IDENTITY;`).if(k,`ALTER TABLE "${t}" ALTER "${n}" DROP IDENTITY;`).if(U,`ALTER TABLE "${t}" ALTER COLUMN "${n}" DROP DEFAULT;`).if(!U&&c!=null,`ALTER TABLE "${t}" ALTER COLUMN "${n}" SET DEFAULT ${c!=null&&c.match(/(:|nextval)/i)?c:`'${c}'`};`).if(i&&i!=m.comment,`COMMENT ON COLUMN "${t}"."${n}" is '${i}';`).if(n!=r,`ALTER TABLE "${t}" RENAME COLUMN "${n}" TO "${r}";`).toString()}showUsers(){return'SELECT usename "user" from pg_user '}pingDataBase(e){return e?`set schema '${e}';`:"select 1"}updateTable(e){const{table:t,newTableName:n,comment:r,newComment:o}=e;let s="";return o&&o!=r&&(s=`COMMENT ON TABLE "${t}" IS '${o}';`),n&&t!=n&&(s+=`ALTER TABLE "${t}" RENAME TO "${n}";`),s}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE "',TABLE_NAME, '";') trun FROM INFORMATION_SCHEMA.TABLES WHERE  table_schema ='${e}' AND table_type='BASE TABLE';`}createDatabase(e){return"CREATE DATABASE $1"}showTableSource(e,t){return""}showViewSource(e,t){return`SELECT CONCAT('CREATE VIEW ',table_name,'
AS
...
BEGIN
    ...
    return 0;
END;
$$ LANGUAGE plpgsql;`}}class ae extends P{showVersion(){return null}createIndex(e){throw new Error("Redshift not support index!")}dropIndex(e,t){return`DROP INDEX "${t}"`}showIndex(e,t){return`select
    t.relname as table_name,
    i.relname as index_name,
    a.attname as column_name,
    ix.indisprimary "isPrimary",
...
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var N;const{name:n,type:r,comment:o,nullable:s,defaultValue:l,extra:i,character_set_name:c,collation_name:m}=t,u=s!="YES";return new d(`ALTER TABLE ${e}`).append(`
	CHANGE ${n} ${n} ${r}`).if(c,`CHARACTER SET ${c}`).if(m,`COLLATE ${m}`).if(u,"NOT NULL").if((N=i==null?void 0:i.toLowerCase())==null?void 0:N.includes("auto_increment"),"AUTO_INCREMENT").if(o,`COMMENT '${o}'`).if(A(l)&&!u,"DEFAULT NULL").if(!A(l),`DEFAULT ${l=="CURRENT_TIMESTAMP"?l:`'${b(l)}'`}`).toString()}updateColumnSql(e){const{table:t,columnName:n,newColumnName:r,columnType:o,isNotNull:s,isAutoIncrement:l,comment:i,defaultValue:c,oldRow:m}=e,u=`ALTER TABLE "${t}"`,N=s?"SET NOT NULL":"DROP NOT NULL";return new d(`${u} ALTER COLUMN "${n}" TYPE ${o};`,`
`).if(i&&i!=m.comment,`${u} ALTER COLUMN "${n}" COMMENT '${i}';`).if(s!=m.isNotNull,`${u} ALTER COLUMN "${n}" ${N};`).if(n!=r,`${u} RENAME COLUMN "${n}" TO "${r}";`).toString()}showCollations(){return""}showChecks(e,t){return""}showUsers(){return"SELECT user user,host host FROM mysql.user;"}pingDataBase(e,t){return e?`use "${t}"."${e}"`:"select 1"}updateTable(e){const{table:t,newTableName:n,comment:r,newComment:o,collation:s,newCollation:l}=e;let i="";return o&&o!=r&&(i=`ALTER TABLE \`${t}\` COMMENT = '${o}';`),l&&l!=s&&(i+=`ALTER TABLE \`${t}\` collate = '${l}';`),n&&t!=n&&(i+=`ALTER TABLE \`${t}\` RENAME TO \`${n}\`;`),i}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE \`',table_schema,'\`.\`',TABLE_NAME, '\`;') trun FROM INFORMATION_SCHEMA.TABLES where  table_schema ='${e}' and TABLE_TYPE<>'VIEW';`}createDatabase(e){return`CREATE DATABASE $1
...
AS
SELECT * FROM $2`}procedureTemplate(){throw new Error("Method not implemented.")}triggerTemplate(){throw new Error("Method not implemented.")}functionTemplate(){throw new Error("Method not implemented.")}processList(){throw new Error("Method not implemented.")}variableList(){throw new Error("Method not implemented.")}statusList(){throw new Error("Method not implemented.")}}function se(a){switch(a||(a=E.MYSQL),a){case null:case E.MYSQL:return new H;case E.MARIA_DB:return new Z;case E.MSSQL:return new te;case E.SQLITE:return new oe;case E.REDSHIFT:return new ae;case E.SNOWFLAKE:return new re;case E.PG:return new P;case E.CLICKHOUSE:return new X;case E.DM:return new J;case E.ORACLE:return new F;case E.ES:return new z;case E.MONGO_DB:return new ee;case E.NEO4J:return new ne}return new Q}class O{constructor(e){this.meta=e,this.dialect=se(e.dbType),this.wrappedTable=$(this.meta.table,this.meta.dbType,Y.Always)}updateTable(e){return this.dialect.updateTable(e)}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","TIMESTAMP","DATE","hr","BOOLEAN","FLOAT","DOUBLE","hr","TEXT","JSON","BLOB"]}strategys(){return["RESTRICT","CASCADE","SET NULL","SET DEFAULT","NO ACTION"]}newColumn(e){const{name:t,type:n,isNotNull:r}=e,o=r?" NOT NULL":"";return`ALTER TABLE ${this.wrappedTable} ADD COLUMN ${$(t,this.meta.dbType)} ${n}${o}`}updateColumn(e){return this.dialect.updateColumnSql({...e,table:this.meta.table})}dropColumn(e){return`ALTER TABLE ${this.wrappedTable} DROP COLUMN ${$(e,this.meta.dbType)}`}formatIndexType(e){return e.index_type}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"}]}dropIndex(e){return this.dialect.dropIndex(this.wrappedTable,e)}showChecks(){return this.dialect.showChecks(this.meta.schema,this.meta.table)}showForeignKeys(){return`SELECT
...
WHERE c.table_schema = '${this.meta.schema}' and c.table_name = '${this.meta.table}' ORDER BY ik.CONSTRAINT_NAME;`}newForeignKey(e){const{column:t,refTable:n,refColumn:r,onUpdate:o,onDelete:s}=e,l=o=="NO ACTION"?"":` ON UPDATE ${o}`,i=s=="NO ACTION"?"":` ON DELETE ${s}`;return`ALTER TABLE "${this.meta.table}" ADD FOREIGN KEY ("${t}") REFERENCES "${n}"("${r}")${l}${i};`}dropForignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT ${e};`}newCheck(e){return`ALTER TABLE ${this.wrappedTable} ADD CHECK (${e});`}dropCheck(e){return`ALTER TABLE ${this.wrappedTable} DROP CONSTRAINT ${e};`}splitColumn(e,t='"'){return e.map(n=>t+n+t).join(",")}}class le extends O{newIndex(e){const{columns:t}=e;return`ALTER TABLE "${this.meta.table}" ADD INDEX ${t.join("")}_${new Date().getTime()}_index expression TYPE type GRANULARITY value AFTER ${this.splitColumn(t)}`}showForeignKeys(){return null}showChecks(){return null}}class ie extends O{newColumn(e){const{name:t,type:n,defaultValue:r,isNotNull:o}=e;return new d(`ALTER TABLE ${$(this.meta.table,this.meta.dbType)} ADD ${$(t,this.meta.dbType)} ${n}`).if(o,"NOT NULL").if(!A(r),`DEFAULT '${b(r)}'`).toString()}newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,o=`${t}_${n.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${o} ON "${t}"(${this.splitColumn(n)});`}showForeignKeys(){return this.dialect.showForeignKeys(this.meta.schema,this.meta.table)}}class ce extends O{indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"FULLTEXT",value:"FULLTEXT"}]}columnTypes(){return["INT",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","DATETIME","TIMESTAMP","DATE","hr","BIT","FLOAT","DOUBLE",{label:"DECIMAL",value:"DECIMAL(10,2)"},"BIGINT","hr","TEXT","JSON","BLOB","hr",{label:"ENUM",value:"ENUM('item')"},{label:"SET",value:"SET('item')"}]}newColumn(e){const{name:t,type:n,comment:r,defaultValue:o,isNotNull:s}=e;return new d(`ALTER TABLE ${this.wrappedTable} ADD COLUMN \`${t}\` ${n}`).if(s,"NOT NULL").if(r,`COMMENT '${r}'`).if(!A(o),`DEFAULT '${b(o)}'`).toString()}formatIndexType(e){const t=e.index_type.toUpperCase();return t=="BTREE"?e.index_name=="PRIMARY"?"PRIMARY":x(e.isUnique)?"UNIQUE":"KEY":t}newIndex(e){const{type:t="key",columns:n}=e;return`ALTER TABLE \`${this.meta.table}\` ADD ${t} (${this.splitColumn(n,"`")})`}newForeignKey(e){const{column:t,refTable:n,refColumn:r,onUpdate:o,onDelete:s}=e,l=o=="NO ACTION"?"":` ON UPDATE ${o}`,i=s=="NO ACTION"?"":` ON DELETE ${s}`;return`ALTER TABLE \`${this.meta.table}\` ADD FOREIGN KEY (\`${t}\`) REFERENCES \`${n}\`(\`${r}\`)${l}${i};`}dropForignKey(e){return`ALTER TABLE \`${this.meta.table}\` DROP FOREIGN KEY ${e};`}}class Ee extends O{newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,o=`${t}_${n.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${o} ON "${t}"(${this.splitColumn(n)})`}newColumn(e){const{name:t,type:n,isNotNull:r,defaultValue:o,comment:s}=e;return new d(`ALTER TABLE ${$(this.meta.table,this.meta.dbType)} ADD ${t} ${n}`).if(!A(o),`DEFAULT '${b(o)}'`).if(r,"NOT NULL").if(s,`;
COMMENT ON COLUMN ${this.wrappedTable}."${t.toUpperCase()}" is '${s}';`).toString()}newForeignKey(e){const{column:t,refTable:n,refColumn:r,onUpdate:o,onDelete:s}=e,l=o=="NO ACTION"?"":` ON UPDATE ${o}`,i=s=="NO ACTION"?"":` ON DELETE ${s}`,c=`${t}_${n}_${r}_fk_${Math.floor(Math.random()*30)}`;return`ALTER TABLE "${this.meta.table}" ADD CONSTRAINT ${c} FOREIGN KEY ("${t}") REFERENCES ${n}(${r})${l}${i};`}showForeignKeys(){var t;let{schema:e}=this.meta;return(e==null?void 0:e.toLowerCase())==((t=this.meta.user)==null?void 0:t.toLowerCase())&&(e=void 0),this.dialect.showForeignKeys(e,this.meta.table)}}class ue extends O{newColumn(e){const{name:t,type:n,comment:r,defaultValue:o,isNotNull:s}=e,l=this.wrappedTable;return new d(`ALTER TABLE ${l} ADD COLUMN "${t}" ${n}`).if(s,"NOT NULL").if(!A(o),`DEFAULT '${b(o)}'`).append(";").if(r,`COMMENT ON COLUMN ${l}."${t}" is '${r}';`).toString()}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"TIMESTAMP","DATE","BOOLEAN","FLOAT","TEXT","JSON","BLOB"]}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"HASH",value:"HASH"}]}newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,o=r=="HASH"?"hash":"btree";return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${n.join("_")}_${new Date().getTime()}_index ON "${t}" USING ${o} (${this.splitColumn(n)});`}showForeignKeys(){return`SELECT
  ...
  GROUP BY
      ...
      ccu.table_schema,
      ccu.table_name
  ORDER BY ord_position;`}}class me extends O{newIndex(e){throw new Error("Method not implemented.")}dropForignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT "${e}";`}showForeignKeys(){return`select
